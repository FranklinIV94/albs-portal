...
async function main() {
  ...
  const services = [
    ...
    // MARKETING OPS SERVICES (One-time project pricing - April 2026)
    {
      id: 'mktg-seo-dashboard',
      name: 'SEO Intelligence Dashboard',
      category: 'MARKETING_OPS' as ServiceCategory,
      description: 'Full SEO audit + monthly tracking dashboard. Setup: $1,500 one-time. Optional $500/mo tracking. Includes GSC audit, keyword research, technical SEO, meta tags, schema, PageSpeed, competitor benchmarking, and 30-day action plan.',
      priceDisplay: '$1,500 setup + $500/mo',
      basePrice: 150000,
      icon: '📊',
      sortOrder: 30,
      isActive: true,
    ...
    {
      id: 'mktg-ai-content-engine',
      name: 'AI Content Engine',
      category: 'MARKETING_OPS' as ServiceCategory,
      description: 'Content machine powered by AI. Setup: $1,000. Per piece: $150-400. Includes blog posts, landing pages, case studies, email sequences — all optimized for Google + AI search (Perplexity, ChatGPT). E-E-A-T compliant, with schema markup and internal linking plans.',
      priceDisplay: '$1,000 setup + $150-400/piece',
      basePrice: 100000,
      icon: '✍️',
      sortOrder: 31,
      isActive: true,
    ...
    {
      id: 'mktg-demand-capture',
      name: 'Demand Capture Automation',
      category: 'MARKETING_OPS' as ServiceCategory,
      description: 'Your AI sales rep, working 24/7. Setup: $2,000. Monthly: $750/mo. Monitors buying intent on X, Reddit, Quora, Telegram/Discord/Slack groups. Auto-replies with your answer. Captures competitor mentions and job postings. No per-message fees.',
      priceDisplay: '$2,000 setup + $750/mo',
      basePrice: 200000,
      icon: '🎯',
      sortOrder: 32,
      isActive: true,
    ...
    {
      id: 'mktg-sales-acceleration',
      name: 'High-Ticket Sales Acceleration',
      category: 'MARKETING_OPS' as ServiceCategory,
      description: 'Close more of the right clients without being pushy. Setup: $1,500. Monthly: $500/mo. Includes authority close framework, demonstration close playbook, cold email sequence (5-touch), objection handling playbook, pitch deck + proposal template. Built on 7 psychological frameworks.',
      priceDisplay: '$1,500 setup + $500/mo',
      basePrice: 150000,
      icon: '💼',
      sortOrder: 33,
    ...
    {
      id: 'mktg-full-ops',
      name: 'Full Marketing Ops — Project Retainer',
      category: 'MARKETING_OPS' as ServiceCategory,
      description: 'Everything built at once. $4,000 one-time project fee. SEO dashboard, 6 blog posts, demand capture setup, sales acceleration framework, OpenClaw configured with all marketing agents, CRM integration, and analytics. After build-out, optional $1,500/mo management — but not required. You own it all.',
      priceDisplay: '$4,000 project',
      basePrice: 400000,
      icon: '🚀',
      sortOrder: 34,
      isActive: true,
...
PERFECT FOR:
Local service businesses (HVAC, plumbing, electrical, roofing, pest control) with a Google Business Profile that has reviews going unanswered.`,
      priceDisplay: '$300/mo',
      basePrice: 30000,
      icon: '⭐',
      sortOrder: 60,
...
PERFECT FOR:
Businesses with ratings below 4.2 stars that need both response management AND new review generation to climb the rankings.`,
      priceDisplay: '$500/mo',
      basePrice: 50000,
      icon: '📈',
      sortOrder: 61,
...
THE RESULT:
Your business becomes the most trusted, highest-rated option in your service area. When someone searches "HVAC near me" or "plumber in [city]," you're the first result with 4.8+ stars and 200+ reviews.

CONTRACT:
90-day minimum commitment

PERFECT FOR:
Businesses that want to dominate their local market and be the obvious first choice for every customer searching online.`,
      priceDisplay: '$800/mo',
      basePrice: 80000,
      icon: '👑',
      sortOrder: 62,
...
ONE-TIME SETUP:
Website build: $800-$1,500 (varies by complexity)

MONTHLY:
Hosting, maintenance, and reputation management: $500/mo

CONTRACT:
90-day minimum commitment on monthly services

PERFECT FOR:
Local service businesses (HVAC, plumbing, roofing, electrical, pest control, landscaping) with no website or a website from 2015 that's costing them customers.`,
  ...
  for (const service of REPUTATION_SERVICES) {
    try {
      ...
      console.log(`Error creating reputation service ${service.id}:`, e)
    }
  }
  console.log(`✅ Seeded ${REPUTATION_SERVICES.length} Reputation Management services`)
